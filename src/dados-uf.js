...
.then(function(response){
    ...
    let confirmedBA = (dados[4].cases)
    let confirmedMA = (dados[5].cases)
    ...
    let confirmedSC = (dados[13].cases)
    let confirmedRN = (dados[14].cases)
    let confirmedPR = (dados[15].cases)
    let confirmedRS = (dados[16].cases)
    let confirmedGO = (dados[17].cases)
    let confirmedSE = (dados[18].cases)
    ...
    let deathsBA = (dados[4].deaths)
    let deathsMA = (dados[5].deaths)
    ...
    let deathsSC = (dados[13].deaths)
    let deathsRN = (dados[14].deaths)
    let deathsPR = (dados[15].deaths)
    let deathsRS = (dados[16].deaths)
    let deathsGO = (dados[17].deaths)
    let deathsSE = (dados[18].deaths)
